...
class ContactActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i("@tmmdl", "contact activity: ${activityName}")
        ...
        contactButton.setOnClickListener {
            ...
            MainActivity.phone = contactPhone.text.toString() // "${getString(R.string.cnt_phone_field)}: ${contactPhone.text} \n${getString(R.string.cnt_mail_field)}: ${contactMail.text}"
            MainActivity.mail = contactMail.text.toString()
            toComment()
        }
    }
